...
from protonmail_organizer import batch as batch_mod
from protonmail_organizer.rules import matches_conditions


class TestMatchesConditions:
    """Tests for matches_conditions (pure matching logic, no API calls)."""
    ...
    def test_matches_sender_is(self):
        ...
        assert matches_conditions(msg, {"sender_is": "alice@example.com"}) is True
    ...
    def test_matches_sender_is_no_match(self):
        ...
        assert matches_conditions(msg, {"sender_is": "alice@example.com"}) is False
    ...
    def test_matches_sender_contains(self):
        ...
        assert matches_conditions(msg, {"sender_contains": "bigcorp"}) is True

    def test_matches_sender_contains_no_match(self):
        """sender_contains rejects when substring is absent."""
        msg = self._make_msg(sender_address="alice@example.com")
        assert matches_conditions(msg, {"sender_contains": "bigcorp"}) is False
    ...
    def test_matches_sender_domain(self):
        ...
        assert matches_conditions(msg, {"sender_domain": "github.com"}) is True
    ...
    def test_matches_sender_domain_no_match(self):
        ...
        assert matches_conditions(msg, {"sender_domain": "github.com"}) is False
    ...
    def test_matches_subject_contains(self):
        ...
        assert matches_conditions(msg, {"subject_contains": "invoice"}) is True
    ...
    def test_matches_subject_contains_no_match(self):
        ...
        assert matches_conditions(msg, {"subject_contains": "invoice"}) is False
    ...
    def test_matches_has_attachment_true(self):
        ...
        assert matches_conditions(msg, {"has_attachment": True}) is True
    ...
    def test_matches_older_than_days(self):
        ...
        assert matches_conditions(msg, {"older_than_days": 60}) is True
    ...
    def test_matches_older_than_days_recent(self):
        ...
        assert matches_conditions(msg, {"older_than_days": 60}) is False
    ...
    def test_matches_multiple_conditions_all_match(self):
        ...
        assert matches_conditions(msg, conditions) is True
    ...
    def test_matches_multiple_conditions_partial_fail(self):
        ...
        assert matches_conditions(msg, conditions) is False

    def test_no_conditions_matches_all(self):
        """Empty conditions dict matches every message."""
        msg = self._make_msg()
        assert matches_conditions(msg, {}) is True
    ...
    def test_sender_missing_address_field(self):
        ...
        assert matches_conditions(msg, {"sender_is": "someone@example.com"}) is False
...
class TestRegexConditions:
    ...
    def test_sender_matches_regex(self):
        ...
        assert matches_conditions(msg, {"sender_matches": r"no-?reply"}) is True

    def test_sender_matches_no_match(self):
        msg = self._msg(addr="alice@example.com")
        assert matches_conditions(msg, {"sender_matches": r"^bob@"}) is False

    def test_subject_matches_regex(self):
        msg = self._msg(subject="Invoice #4821 due")
        assert matches_conditions(msg, {"subject_matches": r"invoice #\d+"}) is True

    def test_regex_is_case_insensitive(self):
        msg = self._msg(subject="URGENT")
        assert matches_conditions(msg, {"subject_matches": r"urgent"}) is True
...
class TestApplyActionsSafety:
    ...
    def test_delete_action_moves_to_trash_not_permanent(self, mock_client, sample_messages):
        ...
        from protonmail_organizer.rules import apply_actions

        apply_actions(mock_client, [sample_messages[0]], {"delete": True}, {})
    ...
    def test_move_to_creates_missing_target_as_folder(
        ...
        apply_actions(mock_client, [sample_messages[0]], {"move_to": "Receipts"}, {})
...
class TestBatchErrorTolerance:
    ...
    def test_record_survives_partial_batch_failure(self, mock_client, monkeypatch):
        ...
        monkeypatch.setattr(batch_mod, "BATCH_DELAY_SECONDS", 0)
        recorded = []
        ...
        rules.apply_actions(mock_client, msgs, {"delete": True}, {})
